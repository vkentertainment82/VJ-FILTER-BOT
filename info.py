...
PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002252849206 -1002224361103').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'https://t.me/dghelps_bot')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('-1002695445766', '0').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/dghelps_bot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/dg_contents')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'dghelps_bot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/dg_contents1')
